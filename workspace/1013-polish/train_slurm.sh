...
# 日志路径
LOG_PATH=/platform_tech/jyren/transpeeder/workspace/1013-polish/logs/slurm_log_$(date '+%m%d%H%M').txt
GPUS_PER_NODE=8
# 节点数
NNODES=4
# 总gpu数
...
# 模型保存路径
OUTPUT=/platform_tech/jyren/transpeeder/workspace/1013-polish/output/${name}
if [ -d $OUTPUT ]; then
    # rm
    echo "${OUTPUT} exist."
else
...
export CMD=" \
    ...
    --data_path /platform_tech/jyren/transpeeder/workspace/1013-polish/train_1017_4096.json \
    --max_seq_len 4096 \
    --train_steps 500 \
    --eval_steps 10 \
    --save_steps 40 \
    ...
    --use_flash_attn true \
    --ntk false \
    --deepspeed_config /platform_tech/jyren/transpeeder/workspace/1013-polish/ds_config_zero1_dgx_70B_8192.json
    "
