...
class Arguments:
    ...
    model_name_or_path: Optional[str] = field(default="/platform_tech/models/deepseek-coder-33b-instruct")
    tokenizer_path: Optional[str] = field(default="/platform_tech/models/deepseek-coder-33b-instruct")
    output_dir: str = field(default="/platform_tech/models/deepseek-coder-33b-instruct-ckpt")
