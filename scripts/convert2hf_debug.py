...
def main():
    ...
    parser.add_argument(
        ...
        default="/platform_tech/sunshuanglong/saved_models/workspace/security-20240206-7b/output/security-20240206-deepseek-llm-7b-add-token3/global_step191",
    ...
    parser.add_argument(
        "--output_dir",
        default="/platform_tech/sunshuanglong/saved_models/workspace/security-20240206-7b/output/security-20240206-deepseek-llm-7b-add-token3/global_191_merge",
