...
class Arguments:
    ...
    model_name_or_path: Optional[str] = field(default="/platform_tech/models/Qwen1.5-32B-Chat")
    tokenizer_path: Optional[str] = field(default="/platform_tech/models/Qwen1.5-32B-Chat")
    output_dir: str = field(default="/platform_tech/models/Qwen1.5-32B-Chat-ckpt")
