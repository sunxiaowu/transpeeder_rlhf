...
class Arguments:
    ...
    model_name_or_path: Optional[str] = field(default="/platform_tech/share_data/sunshuanglong/models/Qwen1.5-0.5B-Chat")
    tokenizer_path: Optional[str] = field(default="/platform_tech/share_data/sunshuanglong/models/Qwen1.5-0.5B-Chat")
    output_dir: str = field(default="/platform_tech/share_data/sunshuanglong/models/Qwen1.5-0.5B-Chat-ckpt")
