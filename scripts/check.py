...
class Arguments:
    ...
    # tokenizer_name_or_path: str = field(default="/platform_tech/models/Yi-34B-init-ckpt-inv-mp1-sliding_windows")
    tokenizer_name_or_path: str = field(default="/platform_tech/models/Qwen1.5-4b-chat-ckpt2")
    data_path: str = field(default="/home/sunshuanglong/transpeeder/workspace/mulu_extract/data/train_type1_v3_step二阶段.jsonl")
    out_path: str = field(default="/home/sunshuanglong/transpeeder/workspace/mulu_extract/data/train_type1_v3_step二阶段_13000_check.jsonl")
    max_seq_len: int = field(default=13000)
