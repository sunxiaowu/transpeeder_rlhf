...
class Arguments:
    ...
    data_path: str = field(default="/home/sunshuanglong/transpeeder/workspace/qinshu-step1-qwen1_5/data/data_sftqingshu_v2_0407.jsonl")
    out_path: str = field(default="/home/sunshuanglong/transpeeder/workspace/qinshu-step1-qwen1_5/data/data_sftqingshu_v2_0407_add_template_20000.jsonl")
    data_path: str = field(default="/platform_tech/xiongrongkang/Dataset/QingShu/extract_sft/all_in_one_v2/data_sftqingshu_all_in_one_v2_train.jsonl")
    out_path: str = field(default="/platform_tech/xiongrongkang/Dataset/QingShu/extract_sft/all_in_one_v2/data_sftqingshu_all_in_one_v2_train_10000_20000.jsonl")
    max_seq_len: int = field(default=20000)
