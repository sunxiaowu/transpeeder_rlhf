...
@dataclass
class Arguments:
    model_name_or_path: Optional[str] = field(default="/platform_tech/sunshuanglong/models/Yi-34B-200K")
    output_dir: str = field(default="/shared_space/agpt/models/Yi-34B-200K-ckpt")
