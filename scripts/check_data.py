...
class Arguments:
    ...
    data_path: str = field(default="/platform_tech/sunshuanglong/academicPro/academicalGPT/script/scim/data_json_extract_1207.jsonl", metadata={"help": "Path to the training data."})
    output_path: str = field(default="/platform_tech/sunshuanglong/academicPro/academicalGPT/script/scim/data_json_extract_1207_check.jsonl")
