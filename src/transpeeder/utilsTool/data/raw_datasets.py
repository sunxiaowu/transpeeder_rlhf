...
class PromptRawDataset(object):
    ...
    def __init__(self, output_path, seed, local_rank, dataset_name):
        ...
        if not dataset_name == 'local/jsonfile':
            print("#" * 20)
            print(dataset_name)
            self.raw_datasets = load_dataset(dataset_name + "/data")
            # self.raw_datasets = load_dataset(dataset_name)
            # /shared_space/liangyuxin/data/RM/0925/rm-static
...
# academicGPT dataset
class AcademicGPTRmstaticDataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = "Academic/rm-static"
        self.dataset_name_clean = "Academic_rm_static"
