...
class DeepSpeedPPOTrainer():
    ...
    def _generate_sequenceBAK(self, prompts, mask, step):
    ...
    def _generate_sequence(self, data_iter,  step):
        ...
        #     kwargs = dict()
        kwargs = dict(do_sample=False)
        eval_logits, outputs = self.actor_model.eval_batch(data_iter=data_iter, return_logits=True)
    ...
    def generate_experience(self, data_iter, step, tokenizer):
        self.eval()
        generate_start = time.time()
        seq = self._generate_sequence(data_iter, step)
