...
from transpeeder.models.yi_pipeline_model import get_model
...
def main():
    ...
    from transpeeder.models.tokenization_yi import YiTokenizer
    from transpeeder.models.configuration_yi import YiConfig
    ...
    model_config = YiConfig.from_pretrained(args.init_ckpt)
